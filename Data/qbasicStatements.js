const qbasicStatements = [
    ...
    {
        qns: "<b>Qbasic Statements </b> <br><h3>In order to learn any programming language, first we have learn how to display ouput and take input from the user on that particular language, then other this becomes very easy. That's why first we focus on how to display output in Qbasic language as well as how to take input from user in Qbasic language.</h3>",
        ans: "1. PRINT Statment <br> It is used to to display output on the console screen/output screen. In Qbasic PRINT statement is used for three purposes <br> <h2>a) It is used to display some message on the console screen. </h2> Look the example below:-",
    ...
    {
        qns: 'b) It is used to display the content of variable on console screen.',
    ...
    {
        qns: 'c) It is the combination of the (a) and (b) i.e. it is used to display message along with the content of variable at the same time.',
